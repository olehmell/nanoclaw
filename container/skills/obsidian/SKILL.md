...
description: >
  ...
  frontmatter, daily notes, backup, or sync. Use this skill for all
  Obsidian vault operations; route across MCP, optional app/CLI actions,
  and git sync with safe defaults.
metadata:
  version: "2.0"
  author: bitbonsai
---
...
Use this as the single Obsidian skill. Prefer MCP for note operations, and
only use app/CLI actions when the user needs behavior MCP cannot provide.
